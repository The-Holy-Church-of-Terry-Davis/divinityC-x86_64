...
EFI_STATUS efi_main(EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable)
{
    ...
    SystemTable->ConOut->OutputString(SystemTable->ConOut, L"Welcome to ");
    ...
    SystemTable->ConOut->OutputString(SystemTable->ConOut, L"DivinityC ");

    SystemTable->ConOut->SetAttribute(SystemTable->ConOut, EFI_WHITE);

    SystemTable->ConOut->OutputString(SystemTable->ConOut, L"EFI\r\n");
